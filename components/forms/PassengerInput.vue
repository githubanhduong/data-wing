...
<template>
	<ActivatorPopperWrapper ref="activatorMenu" class="form-group  form-passenger-mini" :label="label" :error-msg="errorMsg"
		:offset="[0, 3]" :popper-same-width="true" popper-placement="bottom-start" :popper-min-width="205">
		<template #activator="{ elmClass, elmActive, onElmClick, onElmFocus, onElmBlur }">
			<InputWrapper :class="[elmClass, { 'active': elmActive }]"
				:on-events="{ click: onElmClick, focus: onElmFocus, blur: onElmBlur }" readonly
				append-icon="fas fa-users blur-up lazyloaded" input-class="form-control" :value="paxSumary">
			</InputWrapper>
		</template>
				...
				<div class="selector-box-flight">
					<div class="room-cls">
						<div class="qty-box">
							...
							<div class="input-group">
								...
								<input type="text" name="quantity" class="form-control qty-input input-number"
									:maxlength="1" @keydown="allowDigitInput" @focus="selectAllText"
									v-model.number="paxReq.model.nbAdt" />
						...
						<div class="qty-box">
							...
							<div class="input-group">
								...
								<input type="text" name="quantity" class="form-control qty-input input-number"
									:maxlength="1" @keydown="allowDigitInput" @focus="selectAllText"
									v-model.number="paxReq.model.nbChd" />
								<button type="button" class="btn quantity-right-plus" data-type="plus" data-field=""
						...
						<div class="qty-box">
							...
							<div class="input-group">
								...
								<input type="text" name="quantity" class="form-control qty-input input-number"
									:maxlength="1" @keydown="allowDigitInput" @focus="selectAllText"
									v-model.number="paxReq.model.nbInf" />
								<button type="button" class="btn quantity-right-plus" data-type="plus" data-field=""
					...
					<div class="flight-class">
						<div class="form-check">
							<input class="form-check-input radio_animated" type="radio" v-model="paxReq.model.bookingClass"
								:value="BookingClass.ECONOMY" id="class-economy"
								:checked="paxReq.model.bookingClass === BookingClass.ECONOMY">
						...
						<div class="form-check">
							<input class="form-check-input radio_animated" type="radio" v-model="paxReq.model.bookingClass"
								:value="BookingClass.PREMIUM" id="class-premium"
								:checked="paxReq.model.bookingClass === BookingClass.PREMIUM">
						...
						<div class="form-check">
							<input class="form-check-input radio_animated" type="radio" v-model="paxReq.model.bookingClass"
								:value="BookingClass.BUSINESS" id="class-business"
								:checked="paxReq.model.bookingClass === BookingClass.BUSINESS">
...
</ActivatorPopperWrapper></template>
