...
import type { AviahubServiceFee } from '@/common/datawings-ibe';
...
const emits = defineEmits<{
	(e: 'update:seviceFee', val: number): void,
	(e: 'update:adjustment', val: number): void,
}>()
		...
		<div class="col-sm-11">
			...
			<div class="row mt-3">
				...
				<div class="col-sm-2">
					...
					<input type="text" class="form-control borderstyle" :value="seviceFee" @change="$emit('update:seviceFee', ($event.target as any).value)">
				</div>
				<div class="col-sm-2">
					<MessageText tag="span" code="se.form.payment.adjustment" text=".Adjustment (+/-)" /><br/>
					<input type="text" class="form-control borderstyle" :value="adjustment"  @change="$emit('update:adjustment', ($event.target as any).value)">
				</div>
				<div class="col-sm-2">
					<div class="float-end">
