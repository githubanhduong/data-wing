...
import type { PmOther } from '@/common/datawings-payment';
...
const emits = defineEmits<{
	(e: 'update:pmData', index: number, data: PmOther): void,
...
<template>
	<div class="mt-4 dynamic_form pm-credi-card linebt">
		<MessageText tag="h4" class="fw-bold" code="se.form.payment.type.other" text=".Other payment">
